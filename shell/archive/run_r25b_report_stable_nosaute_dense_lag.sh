...
#   Disable Sauté and reactivate dense EV cost as a standard Lagrangian channel.
set -euo pipefail
...
echo ""
echo "============================================"
echo "  R25b Report-Stable No-Saute (Dense-Lag)"
echo "  Same PPO/env/reward recipe as stable run"
echo "  Sauté OFF, dense EV cost ON via EV_DENSE_COST_SCALE=1.0"
echo "  Tests whether C1-dense should exist as a normal constraint"
echo "============================================"
echo ""

/home/christmas/miniconda3/envs/citylearn/bin/python scripts/train_multi_lag.py \
    --cfg configs/on-policy/r25b_report_stable_nosaute_dense_lag.yaml
