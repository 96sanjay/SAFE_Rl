#!/usr/bin/env bash
# R25b bench MID: exact R25 stable reward + Sauté OFF + mid limits
# C0→100, C2=2000, C3=20000, C4=15000, lambda_cap=10.0
set -euo pipefail
...
echo "=== R25b Bench MID: C0→100 C2=2000 C3=20000 C4=15000 ==="
/home/christmas/miniconda3/envs/citylearn/bin/python scripts/train_multi_lag.py \
    --cfg configs/on-policy/r25b_bench_mid.yaml
