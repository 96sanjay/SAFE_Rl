...
# Small, low-risk timing nudges only.
...
echo ""
echo "============================================"
echo "  R25b Report-Stable + Small EV-Solar (10ep)"
echo "  Base: r25b_report_stable"
...
/home/christmas/miniconda3/envs/citylearn/bin/python scripts/train_multi_lag.py \
    --cfg configs/on-policy/r25b_report_stable_ev_solar_small_10ep.yaml
