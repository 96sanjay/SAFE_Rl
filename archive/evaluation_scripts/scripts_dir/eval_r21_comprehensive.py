#!/usr/bin/env python3
"""
R21 PPO Comprehensive Evaluation
=================================
Thorough evaluation of the R21 PPOLagMulti checkpoint covering:
...
Usage:
    python scripts/eval_r21_comprehensive.py [--epoch EPOCH] [--seed SEED]
"""
import os
import sys
import json
...
def evaluate(ckpt_path, seed=42):
    print(f"\n{'='*70}")
    print(f"  R21 PPO — COMPREHENSIVE EVALUATION")
    ...
    out_path = os.path.join(PROJECT, "runs", "r21_ppo_eval_results.json")
