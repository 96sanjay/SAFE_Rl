#!/usr/bin/env bash
# R28: Price-Aware Cycling with Time-Slack V2G
# Changes from R27: time-slack V2G gate, raw price signal, battery gate floor,
#   C3/C4 limits raised (20000/15000), BC warmstart with fixed SmartV2GRBC
set -euo pipefail
set -euo pipefail
...
export STEMS_SOLAR_STORE_BATT_ONLY="1"
# =====================================================================
# R27 CHANGES: Solar-aware price arbitrage
# =====================================================================
# ENABLE: battery price arb with solar credit + linear gate
export STEMS_ALPHA_LOAD_SHIFT="5.0"
# ENABLE: EV slack-gated arbitrage with solar credit
export STEMS_EV_SLACK_ARB_SCALE="2.0"
# DISABLE: harmful terms that cause constant discharge
...
/home/christmas/miniconda3/envs/citylearn/bin/python scripts/train_multi_lag.py \
    --cfg configs/on-policy/r28_cycling.yaml
