#!/usr/bin/env bash
# R25c: R19 + Reduced V2G Context
# SINGLE CHANGE: STEMS_ALPHA_V2G_CONTEXT 3.0 -> 1.0
set -euo pipefail
set -euo pipefail
...
export STEMS_ALPHA_V2G_CONTEXT="1.0"  # R25c: override 3.0->1.0
/home/christmas/miniconda3/envs/citylearn/bin/python scripts/train_multi_lag.py \
    --cfg configs/on-policy/r25c_v2g_reduce.yaml
