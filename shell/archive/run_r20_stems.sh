#!/usr/bin/env bash
# R20: STEMS GCN-Transformer + PPOLagMulti (GPU)
# Same R19 changes + STEMS v3 encoder + GPU training
# Runs ALONGSIDE R19 (R19 on CPU, R20 on GPU)
set -euo pipefail
...
# =====================================================================
# R20: STEMS v3 + Temporal Window + GPU
# =====================================================================
...
echo ""
echo "============================================"
echo "  R20: STEMS GCN-Transformer + PPOLagMulti"
echo "  Architecture: STEMS v3 (GCN + Temporal Transformer)"
echo "  Temporal window: 12 steps"
echo "  Device: CUDA (GPU)"
echo "  All R19 changes included:"
echo "    - Clipping removed"
echo "    - r_load_shift=0, r_ev_guard=1, r_sg=0"
echo "    - C3 limit=3000, C4 limit=1500, λ cap=3.0"
echo "    - PID anti-windup"
echo "  Phase 1 (ep 0-19): C0 disabled"
echo "  Phase 2 (ep 20-40): C0 anneals"
echo "  Phase 3 (ep 40-79): All active"
echo "============================================"
echo ""

python scripts/train_multi_lag_stems.py \
    --cfg configs/on-policy/r20_stems.yaml
