#!/usr/bin/env bash
# R26: R19 + Headroom-Aware Charging
# SINGLE CHANGE: STEMS_ALPHA_HEADROOM=5.0
# Teaches agent HOW MUCH to charge (stay within building power limit)
set -euo pipefail
set -euo pipefail
...
echo ""
echo "============================================"
echo "  R26: Headroom-Aware Charging"
