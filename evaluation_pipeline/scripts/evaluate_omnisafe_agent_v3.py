...
"""
Evaluate a trained OmniSafe agent (epoch-XX.pt) in CityLearnSafetyEnv and write a KPI CSV.
...
def _extract_citylearn_kpis_from_evaluate(env: CityLearnSafetyEnv) -> dict:
    """
