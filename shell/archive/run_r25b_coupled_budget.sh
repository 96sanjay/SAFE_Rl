#!/usr/bin/env bash
# R25b coupled-budget:
# Same 5-building env/reward recipe as r25b_report_stable, but with the new
# structured building-level coupled-budget action wrapper enabled.
set -euo pipefail
...
export CITYLEARN_COUPLED_BUDGET_ACTION="1"

echo ""
echo "============================================"
echo "  R25b Coupled-Budget"
echo "  5-building schema"
echo "  Stable PPO recipe + structured actions"
echo "  budgets per building + EV-share decoder"
echo "============================================"
echo ""

/home/christmas/miniconda3/envs/citylearn/bin/python scripts/train_multi_lag.py \
    --cfg configs/on-policy/r25b_coupled_budget.yaml
