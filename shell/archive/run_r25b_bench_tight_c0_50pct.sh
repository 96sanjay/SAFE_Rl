#!/usr/bin/env bash
# R25b bench TIGHT+50%: exact R25 stable reward + Sauté OFF + C0 50% slack
# C0→50, C0_FLOOR=0.5, C2=1500, C3=15000, C4=10000, lambda_cap=10.0
set -euo pipefail
...
export CITYLEARN_C0_SAFETY_FLOOR="0.5"
...
echo "=== R25b Bench TIGHT+50%: C0→50 C0_FLOOR=0.5 C2=1500 C3=15000 C4=10000 ==="
/home/christmas/miniconda3/envs/citylearn/bin/python scripts/train_multi_lag.py \
    --cfg configs/on-policy/r25b_bench_tight_c0_50pct.yaml
