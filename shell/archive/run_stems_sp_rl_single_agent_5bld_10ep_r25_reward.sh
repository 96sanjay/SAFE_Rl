...
echo ""
echo "============================================"
echo "  STEMS SP-RL Single-Agent 10ep"
echo "  Fair rerun with r25b_report_stable reward/env recipe"
echo "  All-4 projected execution + dense C1 learning"
echo "============================================"
echo ""

python scripts/train_stems_sp_rl_single_agent.py \
  --cfg configs/on-policy/stems_sp_rl_single_agent_5bld_10ep_r25_reward.yaml
