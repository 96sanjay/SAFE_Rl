#!/usr/bin/env python3
"""
1-Building Cycling Test -- Full Year Evaluation
================================================
Loads the best 1bld checkpoint (epoch-50) and runs 1 full year (8759 steps)
...
OUT_DIR = f"{PROJECT}/runs/test_1bld"
...
def evaluate(epoch=50, seed=42):
    ...
    print(f"\n{'='*72}")
    print(f"  1-BUILDING CYCLING TEST -- FULL YEAR EVALUATION")
    ...
    # =====================================================================
    print(f"\n{'='*72}")
    print(f"  1-BUILDING EVALUATION RESULTS (epoch-{epoch}, full year)")
    print(f"{'='*72}")
    ...
    fig.suptitle(
        f"1-Building Cycling Test (epoch-{epoch}, full year)\n"
    ...
    plt.tight_layout()
    out_path = os.path.join(OUT_DIR, "eval_1bld.png")
