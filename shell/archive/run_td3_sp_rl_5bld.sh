#!/usr/bin/env bash
# TD3 SP-RL: 5-building, full year
# Same reward as R21. Projection handles C2/C3/C4. Lagrangian handles C0/C1.
set -euo pipefail
...
RUN_DIR="runs/td3_sp_rl_5bld_s${SEED}"

echo ""
echo "============================================"
echo "  TD3 SP-RL 5-building (seed=$SEED)"
echo "  DiffProjector: C2/C3/C4 hard (cvxpylayers)"
echo "  Lagrangian: C0/C1 (PID)"
echo "  PenC penalty critic"
echo "  50 epochs, 8759 steps/epoch"
...
/home/christmas/miniconda3/envs/citylearn/bin/python scripts/train_td3_sp_rl.py \
    --cfg configs/off-policy/td3_sp_rl_5bld.yaml \
