#!/usr/bin/env bash
# R27: Solar-Aware Price Arbitrage (4-term reward)
# Changes: enable load_shift+ev_slack_arb, disable r_ren+r_grid_mild+r_solar_store+r_v2g_ctx
# Hyperparams: batch=256, kl=0.08
set -euo pipefail
set -euo pipefail
...
echo ""
echo "============================================"
echo "  R27: Solar-Aware Price Arbitrage"
...
/home/christmas/miniconda3/envs/citylearn/bin/python scripts/train_multi_lag.py \
    --cfg configs/on-policy/r27_price_arb.yaml
