#!/usr/bin/env bash
# 10-epoch verdict run for the 5-building coupled-budget action design.
set -euo pipefail
...
echo ""
echo "============================================"
echo "  R25b Coupled-Budget (10 epochs)"
...
/home/christmas/miniconda3/envs/citylearn/bin/python scripts/train_multi_lag.py \
    --cfg configs/on-policy/r25b_coupled_budget_10ep.yaml
