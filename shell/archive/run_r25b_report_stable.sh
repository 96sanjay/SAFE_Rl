#!/usr/bin/env bash
# R25b report-stable:
# Same env/reward recipe as r25b_ev_slack_arb, but milder PPO/Lagrangian
# settings for cleaner training curves and a more stable reportable run.
set -euo pipefail
...
echo ""
echo "============================================"
echo "  R25b Report-Stable"
echo "  Same reward/env as r25b_ev_slack_arb"
echo "  PPO stabilized: batch=256, update_iters=10"
echo "  target_kl=0.06, max_grad_norm=0.5"
echo "  Milder lambda/PID for C3/C4"
echo "============================================"
echo ""
