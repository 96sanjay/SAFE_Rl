#!/usr/bin/env bash
# R25b report-stable ablation:
#   Disable Sauté while keeping dense EV cost OFF.
# This isolates the effect of removing the Sauté budget observation and unsafe
# reward path without reintroducing C1-dense as a standard Lagrangian channel.
set -euo pipefail
...
export CITYLEARN_EV_DENSE_COST_SCALE="0.0"
...
echo ""
echo "============================================"
echo "  R25b Report-Stable No-Saute (Obs-Only)"
echo "  Same PPO/env/reward recipe as stable run"
echo "  Sauté OFF, dense EV cost remains OFF"
echo "  Tests whether the Sauté budget observation/path matters"
echo "============================================"
echo ""

/home/christmas/miniconda3/envs/citylearn/bin/python scripts/train_multi_lag.py \
    --cfg configs/on-policy/r25b_report_stable_nosaute_obs_only.yaml
