#!/usr/bin/env bash
# R18: Curriculum smoke test (3 epochs) — verify curriculum machinery
set -euo pipefail
...
echo ""
echo "============================================"
echo "  R18: SMOKE TEST (3 epochs)"
echo "  Curriculum: C0 anneals in epochs 1-2"
echo "============================================"
echo ""

python scripts/train_multi_lag.py \
    --cfg configs/on-policy/r18_curriculum_smoke.yaml
