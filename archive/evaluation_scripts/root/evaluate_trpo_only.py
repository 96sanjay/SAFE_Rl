#!/usr/bin/env python3
"""Evaluate TRPO Baseline with full metrics"""
...
# TRPO checkpoint (epoch-50)
TRPO_CKPT = "runs/trpo_baseline_v2/TRPO-{CityLearnSafety-SoC-v0}/seed-042-2026-02-05-23-58-36/torch_save/epoch-50.pt"

print("\n" + "="*80)
print("TRPO BASELINE EVALUATION")
print("="*80)

# Create agent
print(f"\nLoading checkpoint: {TRPO_CKPT}")
agent = OmniSafeCheckpointAgent(TRPO_CKPT, name="trpo_baseline")
...
result = evaluator.evaluate(agent, seed=42, run_name="EVAL_TRPO_Baseline")
...
# Save results
output_dir = Path("runs/evaluations/trpo_baseline_single")
