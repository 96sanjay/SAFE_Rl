#!/usr/bin/env bash
# R25b benchmark variant:
# - r_barrier DISABLED → C2 constraint RE-ENABLED
# - C0 limit tightened: 1800 → 500
# For benchmarking PPOLagMulti against vanilla OmniSafe baselines.
set -euo pipefail
...
export STEMS_ALPHA_BARRIER="0.0"          # DISABLED (was 0.5) — moved to C2 constraint
...
export COST_W_C2="5.0"                    # RE-ENABLED (was 0.0) — replaces r_barrier
...
echo "============================================"
echo "  R25b Benchmark"
echo "  r_barrier=OFF → C2 constraint ON (w=5.0)"
echo "  C0 limit: 1800 → 500 (tighter)"
echo "  4 active constraints: C0, C2, C3, C4"
echo "============================================"
echo ""

/home/christmas/miniconda3/envs/citylearn/bin/python scripts/train_multi_lag.py \
    --cfg configs/on-policy/r25b_benchmark.yaml
