#!/usr/bin/env bash
# Low-risk r25b variant:
# - small EV-solar reward
# - tiny solar-store reward
# Goal: improve EV timing without materially distorting KPIs.
set -euo pipefail
...
# New low-risk timing nudges.
export STEMS_ALPHA_EV_SOLAR="0.3"
export STEMS_ALPHA_SOLAR_STORE="0.08"
...
echo ""
echo "============================================"
echo "  R25b Small EV-Solar Test (10 epochs)"
echo "  Base: r25b_ev_slack_arb"
echo "  Added: STEMS_ALPHA_EV_SOLAR=0.3"
echo "  Added: STEMS_ALPHA_SOLAR_STORE=0.08"
echo "  Goal: improve EV timing with low KPI risk"
echo "============================================"
echo ""

/home/christmas/miniconda3/envs/citylearn/bin/python scripts/train_multi_lag.py \
    --cfg configs/on-policy/r25b_ev_solar_small_10ep.yaml
