#!/usr/bin/env bash
# R25b report-stable + STEMS v3 on the 5-building schema.
# Keep PPOLagMulti and stable Lagrangian settings unchanged.
# Swap only the policy backbone to STEMS v3:
#   - Spatial GCN over buildings
#   - Per-node temporal Transformer with 12-step history
set -euo pipefail
...
echo ""
echo "============================================"
echo "  R25b Report-Stable + STEMS v3"
echo "  5-building schema"
echo "  Algorithm: PPOLagMulti (unchanged)"
echo "  Backbone: STEMS v3 (GCN + temporal Transformer)"
echo "  Temporal window: 12"
echo "  Short run: 10 epochs"
echo "============================================"
echo ""

/home/christmas/miniconda3/envs/citylearn/bin/python scripts/train_multi_lag_stems.py \
    --cfg configs/on-policy/r25b_report_stable_stems_v3_10ep.yaml
