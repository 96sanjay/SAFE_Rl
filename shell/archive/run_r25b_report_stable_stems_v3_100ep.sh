...
# Same PPOLagMulti/Lagrangian recipe as r25b_report_stable.
# Only the actor backbone changes to STEMS v3 (GCN + temporal Transformer).
set -euo pipefail
...
echo "  Long run: 100 epochs"
echo "============================================"
echo ""

/home/christmas/miniconda3/envs/citylearn/bin/python scripts/train_multi_lag_stems.py \
    --cfg configs/on-policy/r25b_report_stable_stems_v3_100ep.yaml
