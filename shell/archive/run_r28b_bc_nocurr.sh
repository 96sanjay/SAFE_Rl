#!/usr/bin/env bash
# R28b: R28 + BC warmstart + No Curriculum + GPU
# Same reward as R28 but: BC from SmartV2GRBC, C0 active from epoch 0, GPU training
set -euo pipefail
set -euo pipefail
...
echo ""
echo "============================================"
echo "  R28b: BC + No Curriculum + GPU"
...
/home/christmas/miniconda3/envs/citylearn/bin/python scripts/train_multi_lag.py \
    --cfg configs/on-policy/r28b_bc_nocurr.yaml --bc --no-curriculum
