#!/usr/bin/env bash
# R25b bench LOOSE: exact R25 stable reward + Sauté OFF + loose limits
# C0→200, C2=3000, C3=25000, C4=18000, lambda_cap=10.0
set -euo pipefail
...
echo "=== R25b Bench LOOSE: C0→200 C2=3000 C3=25000 C4=18000 ==="
/home/christmas/miniconda3/envs/citylearn/bin/python scripts/train_multi_lag.py \
    --cfg configs/on-policy/r25b_bench_loose.yaml
