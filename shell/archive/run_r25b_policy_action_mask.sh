#!/usr/bin/env bash
# R25b ablation: policy-side continuous action masking.
# Single main change versus run_r25b_ev_slack_arb.sh:
...
export CITYLEARN_POLICY_ACTION_MASK="1"
export MASK_C4_ENABLED="0"
export POLICY_MASK_EV_ENFORCE_MIN_CHARGE="1"
export POLICY_MASK_EV_FORCE_ONLY_WHEN_CRITICAL="1"

export STEMS_EV_SLACK_ARB_SCALE="2.0"

echo ""
echo "============================================"
echo "  R25b Ablation: Policy-Side Action Mask"
echo "  Base: r25b_ev_slack_arb"
echo "  Main change: actor rollout/update uses masked action space"
echo "============================================"
echo ""

/home/christmas/miniconda3/envs/citylearn/bin/python scripts/train_multi_lag.py \
    --cfg configs/on-policy/r25b_policy_action_mask.yaml
