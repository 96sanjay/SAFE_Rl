#!/usr/bin/env python3
"""Evaluate FOCOPS_V2 only with full metrics"""
...
# FOCOPS checkpoint
FOCOPS_CKPT = "runs/focops_P95_V2/FOCOPS-{CityLearnSafety-SoC-v0}/seed-000-2026-02-05-03-18-10/torch_save/epoch-100.pt"

print("\n" + "="*80)
print("FOCOPS V2 EVALUATION")
print("="*80)

# Create agent
print(f"\nLoading checkpoint: {FOCOPS_CKPT}")
agent = OmniSafeCheckpointAgent(FOCOPS_CKPT, name="focops_v2")
...
result = evaluator.evaluate(agent, seed=42, run_name="EVAL_FOCOPS_V2")
...
# Save results
output_dir = Path("runs/evaluations/focops_v2_single")
