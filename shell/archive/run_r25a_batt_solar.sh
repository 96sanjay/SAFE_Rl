#!/usr/bin/env bash
# R25a: R19 + Battery-Only Solar Store
# SINGLE CHANGE: STEMS_ALPHA_SOLAR_STORE=3.0, STEMS_SOLAR_STORE_BATT_ONLY=1
set -euo pipefail
set -euo pipefail
...
echo ""
echo "============================================"
echo "  R25a: Battery-Only Solar Store"
...
/home/christmas/miniconda3/envs/citylearn/bin/python scripts/train_multi_lag.py \
    --cfg configs/on-policy/r25a_batt_solar.yaml
