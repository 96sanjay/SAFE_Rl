#!/usr/bin/env bash
# R25b bench TIGHT: exact R25 stable reward + Sauté OFF + tighter limits
# C0→50, C2=1500, C3=15000, C4=10000, lambda_cap=10.0
set -euo pipefail
...
echo "=== R25b Bench TIGHT: C0→50 C2=1500 C3=15000 C4=10000 ==="
/home/christmas/miniconda3/envs/citylearn/bin/python scripts/train_multi_lag.py \
    --cfg configs/on-policy/r25b_bench_tight.yaml
