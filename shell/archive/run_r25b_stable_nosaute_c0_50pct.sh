#!/usr/bin/env bash
# R25b report-stable — EXACT SAME reward/env
# ONLY 2 changes:
#   1. Sauté DISABLED (CITYLEARN_EV_SAUTE=0)
#   2. C0 departure slack 50% (CITYLEARN_C0_SAFETY_FLOOR=0.5)
set -euo pipefail
...
export CITYLEARN_EV_SAUTE="0"                    # CHANGE 1: Sauté OFF
...
export CITYLEARN_C0_SAFETY_FLOOR="0.5"           # CHANGE 2: 50% departure slack

# === EVERYTHING BELOW IS IDENTICAL TO R25b STABLE ===
...
echo ""
echo "============================================"
echo "  R25b Stable + No Sauté + C0 50% slack"
echo "  Exact R25b reward/env"
echo "  Sauté OFF, C0_SAFETY_FLOOR=0.5"
echo "============================================"
echo ""

/home/christmas/miniconda3/envs/citylearn/bin/python scripts/train_multi_lag.py \
    --cfg configs/on-policy/r25b_report_stable.yaml
