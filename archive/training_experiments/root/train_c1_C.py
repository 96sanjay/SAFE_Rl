import omnisafe, citylearn_safe.omni_env_forecast
agent = omnisafe.Agent("TRPOLag", "CityLearnSafety-Forecast-v0", custom_cfgs={
    "seed": 42,
    ...
    "logger_cfgs": {"log_dir": "./runs/c1_C_forecast", "save_model_freq": 10},
})
agent.learn()
