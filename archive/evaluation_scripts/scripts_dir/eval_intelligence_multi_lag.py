#!/usr/bin/env python3
"""
Intelligence Evaluation: PPOLagMulti vs R5a, GradS v3 baselines.
...
Agent obs dims:
  - R5a:          obs_dim=198  (SPATIAL_OBS=0, C3_CONTROLLABLE=0)
  - GradS v3:     obs_dim=218  (SPATIAL_OBS=1, C3_CONTROLLABLE=1)
  - PPOLagMulti:  obs_dim=218  (SPATIAL_OBS=1, C3_CONTROLLABLE=1)
"""
import os
import sys
import json
