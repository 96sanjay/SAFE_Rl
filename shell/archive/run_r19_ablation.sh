#!/usr/bin/env bash
# R19: Ablation on R18 Curriculum
# Changes from R18:
#   1. Cost advantage clipping REMOVED (ppo_lag_multi.py line 308-311)
#   2. 3 reward signals zeroed: r_load_shift, r_ev_guard, r_sg
#   3. Cost limits tightened: C3 12000→3000, C4 2500→1500
#   4. Extended to 80 epochs, Phase 2 extended to ep 40
set -euo pipefail
...
echo ""
echo "============================================"
echo "  R19: Ablation on R18 Curriculum"
...
python scripts/train_multi_lag.py \
    --cfg configs/on-policy/r19_ablation.yaml
