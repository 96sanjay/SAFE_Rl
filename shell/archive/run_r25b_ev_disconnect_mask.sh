#!/usr/bin/env bash
# R25b ablation: zero EV actions when no EV is connected.
# Single change versus run_r25b_ev_slack_arb.sh:
#   export CITYLEARN_EV_DISCONNECT_MASK="1"
set -euo pipefail
...
# Clamps OFF, narrow EV disconnect ablation ON
...
echo ""
echo "============================================"
echo "  R25b Ablation: EV Disconnect Mask"
echo "  Base: r25b_ev_slack_arb"
echo "  Single change: zero EV actions when disconnected"
echo "============================================"
echo ""

/home/christmas/miniconda3/envs/citylearn/bin/python scripts/train_multi_lag.py \
    --cfg configs/on-policy/r25b_ev_disconnect_mask.yaml
